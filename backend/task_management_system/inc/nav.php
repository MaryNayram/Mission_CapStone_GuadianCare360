<nav class="side-bar" style="width: 240px; background: rgba(0,0,0,0.6); backdrop-filter: blur(10px); color: #131010ff; min-height: 100vh; padding-top: 20px; box-shadow: 0 0 12px rgba(0,0,0,0.3);">
    ...
    <?php if ($_SESSION['role'] === "employee") { ?>
      ...
      <li class="position-relative">
        <a href="notifications.php" class="nav-link">
          ...
          <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger px-2" style="font-size: 12px;" id="sidebarNotificationCount">
