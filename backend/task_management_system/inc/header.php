...
<header class="header d-flex justify-content-between align-items-center px-3 py-2 shadow-sm"
        style="background: rgba(32, 35, 36, 0.6); backdrop-filter: blur(10px); color: #fff;">
  ...
  <!-- Notification Icon -->
  <button id="notificationToggle" class="btn position-relative p-0 border-0 bg-transparent" style="cursor:pointer;">
...
<div class="notification-bar animate__animated" id="notificationBar"
     style="position: absolute; top: 60px; right: 20px; width: 300px; background: rgba(37, 231, 215, 0.85);
